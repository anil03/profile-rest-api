...
PROJECT_GIT_URL='https://github.com/anil03/profile-rest-api.git'
...
cp $PROJECT_BASE_PATH/profiles-rest-api/deploy/nginx_profile_api.conf /etc/nginx/sites-available/profile_api.conf
